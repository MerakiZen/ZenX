...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/zenx/backend/proto/auth/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AuthServiceName = "zenx.auth.v1.AuthService"
)
...
const (
	...
	// RPC.
	AuthServiceRegisterUserProcedure = "/zenx.auth.v1.AuthService/RegisterUser"
	// AuthServiceLoginProcedure is the fully-qualified name of the AuthService's Login RPC.
	AuthServiceLoginProcedure = "/zenx.auth.v1.AuthService/Login"
	// AuthServiceValidateTokenProcedure is the fully-qualified name of the AuthService's ValidateToken
	// RPC.
	AuthServiceValidateTokenProcedure = "/zenx.auth.v1.AuthService/ValidateToken"
	// AuthServiceRefreshTokenProcedure is the fully-qualified name of the AuthService's RefreshToken
	// RPC.
	AuthServiceRefreshTokenProcedure = "/zenx.auth.v1.AuthService/RefreshToken"
)

// AuthServiceClient is a client for the zenx.auth.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the zenx.auth.v1.AuthService service. By default, it
...
// RegisterUser calls zenx.auth.v1.AuthService.RegisterUser.
...
// Login calls zenx.auth.v1.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// ValidateToken calls zenx.auth.v1.AuthService.ValidateToken.
...
// RefreshToken calls zenx.auth.v1.AuthService.RefreshToken.
...
// AuthServiceHandler is an implementation of the zenx.auth.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/zenx.auth.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) RegisterUser(context.Context, *connect.Request[v1.RegisterUserRequest]) (*connect.Response[v1.RegisterUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("zenx.auth.v1.AuthService.RegisterUser is not implemented"))
}

func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("zenx.auth.v1.AuthService.Login is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ValidateToken(context.Context, *connect.Request[v1.ValidateTokenRequest]) (*connect.Response[v1.ValidateTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("zenx.auth.v1.AuthService.ValidateToken is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RefreshToken(context.Context, *connect.Request[v1.RefreshTokenRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("zenx.auth.v1.AuthService.RefreshToken is not implemented"))
}
